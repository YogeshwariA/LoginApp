...
public class HomeServlet extends HttpServlet {
	...
	private void welcomeUser(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (session == null || session.getAttribute("user") == null) {
			...
			String responseString = "<html><head><link type='text/css' rel='stylesheet' href='css/bootstrap.css'></head><div id='welcomeDiv' class='card' style='top:50px;margin-left: 500px; height: 200px; width: 300px;'>"
					...
					+ "<a align='right' class='link' style='text-align:right' href=/logoutconfirm>Logout</a></div></div></html>";
